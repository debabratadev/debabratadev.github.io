/**
 * Handles row spacing for matrices
 */
var matrixSpace= (function () {

    let elemId = document.getElementById('matrix-space');
    ...
    function dragMouseDown(e) {
        ...
        body.addEventListener('mousemove', matrixSpace.elementDrag);
        body.addEventListener('mouseup', matrixSpace.closeDrag);
    ...
    function elementDrag(e) {
        mouseObject.elementDrag(e,'matrix', 'matrix-space');// need to create for section also
    ...
    function closeDrag(e) {
        body.removeEventListener('mousemove', matrixSpace.elementDrag);
        body.removeEventListener('mouseup', matrixSpace.closeDrag);
    ...
    function onClick() {
        ...
        if (elemId.onmousedown) {
            elemId.removeEventListener('mousedown', matrixSpace.dragMouseDown);
        }
        else {
            elemId.addEventListener('mousedown', matrixSpace.dragMouseDown);
        }
    }
