function createColorGame(levelConfig, enableSound) {
    ...
    var colorGame = {
      ...
      getColors: function(diff) {
        ...
        var diffColor = [color[0] + difference, color[1] + difference, color[2] + difference];
  
        return ['rgb(' + color.join(',') + ')', 'rgb(' + diffColor.join(',') + ')'];
      },
